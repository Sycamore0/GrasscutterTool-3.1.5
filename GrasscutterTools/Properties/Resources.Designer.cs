...
namespace GrasscutterTools.Properties {
    ...
    internal class Resources {
        ...
        /// <summary>
        ///   查找类似 1: credit：Sakura616#0807
        ///2: credit：umaru#6658
        ///3: credit：WindSeedClientNotify#7094
        ///4: credit：庫卡🅺🅾🅺🅰#8595
        ///70330224: SceneObj_Desert_HeadControlShooter{头部控制射手}
        ///70330225: 一个跟随的蓝色光锥{靠近跟随}
        ///70330226: 未知{会以极快的速度发射某种东西}
        ///70330227: 一个沙漏{有翻转选项}
        ///70330228: 沙漏2{有翻转选项} [字符串的其余部分被截断]&quot;; 的本地化字符串。
        /// </summary>
