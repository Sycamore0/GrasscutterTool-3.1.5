...
namespace GrasscutterTools.Forms
{
    public partial class FormMain : Form
    {
        ...
        {
            Text += "  - by Syca  - v" + AppVersion.ToString(3);
#if DEBUG
            Text += "-debug";
#endif
        ...
        private void LnkThis_LinkClicked(object sender, LinkLabelLinkClickedEventArgs e)
        {
            OpenURL("https://github.com/TeyvatL/GrasscutterTool-3.1.5");
        }
